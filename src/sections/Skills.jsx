...
//   // random timing untuk idle CSS animation (ringan)
...
//       {/* HEADER — tetap pakai component, tapi dibalik dengan reverse */}
...
//   );
// }
"use client"; // PENTING: Menandakan ini adalah Client Component di Next.js App Router
...
export default function Skills() {
  ...
  // 2. Gunakan useEffect untuk menghitung nilai random HANYA di client
  ...
  // useGSAP tetap berjalan seperti biasa
  useGSAP(() => {
    const items = gsap.utils.toArray(".skill-item");
    // Entrance sekali jalan
    gsap.fromTo(
